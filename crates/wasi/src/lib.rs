...
use wasm_types::{FuncType, FuncTypeBuilder, ValType};
...
// we introduce an own version of the boundary cc func type to remove the dependency on the CalleeCtxt
pub type BoundaryCCFuncTy =
    unsafe extern "C" fn(*mut WasiContext, *const ValueRaw, *mut ValueRaw) -> ();
...
pub const WASI_FUNCS: Lazy<HashSet<(&str, &str)>> = Lazy::new(|| {
    HashSet::from([
...
impl WasiContext {
    ...
    pub fn get_func_by_name(module: &str, name: &str) -> (BoundaryCCFuncTy, FuncType) {
...
static WASI_SNAPSHOT_PREVIEW1__ARGS_GET: Lazy<(BoundaryCCFuncTy, FuncType)> = Lazy::new(|| {
    (
...
static WASI_SNAPSHOT_PREVIEW1__ARGS_SIZES_GET: Lazy<(BoundaryCCFuncTy, FuncType)> =
    Lazy::new(|| {
        (
...
static WASI_SNAPSHOT_PREVIEW1__ENVIRON_GET: Lazy<(BoundaryCCFuncTy, FuncType)> = Lazy::new(|| {
    (
...
static WASI_SNAPSHOT_PREVIEW1__ENVIRON_SIZES_GET: Lazy<(BoundaryCCFuncTy, FuncType)> =
    Lazy::new(|| {
        (
...
static WASI_SNAPSHOT_PREVIEW1__PROC_EXIT: Lazy<(BoundaryCCFuncTy, FuncType)> = Lazy::new(|| {
    (
...
static WASI_SNAPSHOT_PREVIEW1__FD_WRITE: Lazy<(BoundaryCCFuncTy, FuncType)> = Lazy::new(|| {
    (
...
static WASI_SNAPSHOT_PREVIEW1__FD_CLOSE: Lazy<(BoundaryCCFuncTy, FuncType)> = Lazy::new(|| {
    (
...
static WASI_SNAPSHOT_PREVIEW1__FD_FDSTAT_GET: Lazy<(BoundaryCCFuncTy, FuncType)> =
    Lazy::new(|| {
        (
...
static WASI_SNAPSHOT_PREVIEW1__FD_SEEK: Lazy<(BoundaryCCFuncTy, FuncType)> = Lazy::new(|| {
    (
        WasiContext::fd_seek,
        FuncTypeBuilder::create(
...
static WASI_SNAPSHOT_PREVIEW1__FD_FDSTAT_SET_FLAGS: Lazy<(BoundaryCCFuncTy, FuncType)> =
    Lazy::new(|| {
        (
...
static WASI_SNAPSHOT_PREVIEW1__FD_PRESTAT_GET: Lazy<(BoundaryCCFuncTy, FuncType)> =
    Lazy::new(|| {
        (
...
static WASI_SNAPSHOT_PREVIEW1__FD_PRESTAT_DIR_NAME: Lazy<(BoundaryCCFuncTy, FuncType)> =
    Lazy::new(|| {
        (
...
static WASI_SNAPSHOT_PREVIEW1__FD_READ: Lazy<(BoundaryCCFuncTy, FuncType)> = Lazy::new(|| {
    (
        WasiContext::fd_read,
        FuncTypeBuilder::create(
...
static WASI_SNAPSHOT_PREVIEW1__PATH_OPEN: Lazy<(BoundaryCCFuncTy, FuncType)> = Lazy::new(|| {
    (
...
static WASI_SNAPSHOT_PREVIEW1__PATH_FILESTAT_GET: Lazy<(BoundaryCCFuncTy, FuncType)> =
    Lazy::new(|| {
        (
...
static WASI_SNAPSHOT_PREVIEW1__FD_FILESTAT_GET: Lazy<(BoundaryCCFuncTy, FuncType)> =
    Lazy::new(|| {
        (
