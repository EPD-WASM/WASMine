...
impl FunctionBuilder {
    ...
    pub(crate) fn terminate_else(&mut self, output_vars: SmallVec<[VariableID; 0]>) {
        self.current_bb_get_mut().terminator = BasicBlockGlue::ElseMarker { output_vars };
    }

    pub(crate) fn terminate_return(&mut self, return_vars: SmallVec<[VariableID; 1]>) {
