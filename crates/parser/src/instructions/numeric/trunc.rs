...
mod specializations {
    use super::*;
    pub(crate) fn i32_trunc_sat_f32_s(c: &mut C, _: &mut I, o: &mut O) -> PR {parse_trunc_sat(c, o, NumType::F32, NumType::I32, true)}
    pub(crate) fn i32_trunc_sat_f32_u(c: &mut C, _: &mut I, o: &mut O) -> PR {parse_trunc_sat(c, o, NumType::F32, NumType::I32, false)}
    pub(crate) fn i32_trunc_sat_f64_s(c: &mut C, _: &mut I, o: &mut O) -> PR {parse_trunc_sat(c, o, NumType::F64, NumType::I32, true)}
    pub(crate) fn i32_trunc_sat_f64_u(c: &mut C, _: &mut I, o: &mut O) -> PR {parse_trunc_sat(c, o, NumType::F64, NumType::I32, false)}
    pub(crate) fn i64_trunc_sat_f32_s(c: &mut C, _: &mut I, o: &mut O) -> PR {parse_trunc_sat(c, o, NumType::F32, NumType::I64, true)}
    pub(crate) fn i64_trunc_sat_f32_u(c: &mut C, _: &mut I, o: &mut O) -> PR {parse_trunc_sat(c, o, NumType::F32, NumType::I64, false)}
    pub(crate) fn i64_trunc_sat_f64_s(c: &mut C, _: &mut I, o: &mut O) -> PR {parse_trunc_sat(c, o, NumType::F64, NumType::I64, true)}
    pub(crate) fn i64_trunc_sat_f64_u(c: &mut C, _: &mut I, o: &mut O) -> PR {parse_trunc_sat(c, o, NumType::F64, NumType::I64, false)}
}
