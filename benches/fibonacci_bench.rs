...
criterion_group!(
    ...
    targets = wasmine_llvm_fibonacci, wasmine_llvm_translation_fibonacci, wasmine_interp_fibonacci, wasmtime_fibonacci, wasmedge_fibonacci, wasmine_parsing_fibonacci
);
