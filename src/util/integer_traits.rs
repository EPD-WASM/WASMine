...
impl Integer for i8 {
    fn from_le_bytes(bytes: &[u8]) -> Self {
        i8::from_le_bytes(<[u8; 1]>::try_from(bytes).unwrap())
    }
...
impl Integer for i16 {
    fn from_le_bytes(bytes: &[u8]) -> Self {
        i16::from_le_bytes(<[u8; 2]>::try_from(bytes).unwrap())
    }
...
impl Integer for i32 {
    fn from_le_bytes(bytes: &[u8]) -> Self {
        i32::from_le_bytes(<[u8; 4]>::try_from(bytes).unwrap())
    }
...
impl Integer for i64 {
    fn from_le_bytes(bytes: &[u8]) -> Self {
        i64::from_le_bytes(<[u8; 8]>::try_from(bytes).unwrap())
    }
...
impl Integer for isize {
    fn from_le_bytes(bytes: &[u8]) -> Self {
        isize::from_le_bytes(<[u8; std::mem::size_of::<isize>()]>::try_from(bytes).unwrap())
    }
...
impl Integer for u8 {
    fn from_le_bytes(bytes: &[u8]) -> Self {
        u8::from_le_bytes(<[u8; 1]>::try_from(bytes).unwrap())
    }
...
impl Integer for usize {
    fn from_le_bytes(bytes: &[u8]) -> Self {
        usize::from_le_bytes(<[u8; std::mem::size_of::<usize>()]>::try_from(bytes).unwrap())
    }
