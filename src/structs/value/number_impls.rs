use crate::util::numeric_transmutes::{Bit32, Bit64};
use wasm_types::NumType;

use super::Number;

impl Number {
    pub(crate) fn trans_to_u64(&self) -> u64 {
        match *self {
    ...
    pub(crate) fn trans_from_u64(n: u64, t: &NumType) -> Number {
        match t {
    ...
    pub(crate) fn as_signed(&self) -> Number {
        match *self {
    ...
    pub(crate) fn as_unsigned(&self) -> Number {
        match *self {
    ...
    pub(crate) fn rotate_left(&self, n: Number) -> Number {
        match (self, n) {
    ...
    pub(crate) fn rotate_right(&self, n: Number) -> Number {
        match (self, n) {
    ...
    pub(crate) fn nearest(&self) -> Number {
        match *self {
    ...
    pub(crate) fn min(&self, other: &Number) -> Number {
        match (self, other) {
    ...
    pub(crate) fn max(&self, other: &Number) -> Number {
        match (self, other) {
    ...
    pub(crate) fn copysign(&self, other: &Number) -> Number {
        match (self, other) {
