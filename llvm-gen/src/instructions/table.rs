...
use wasm_types::{InstructionType, TableIdx, TableInstructionCategory, ValType};
        ...
        match instr_type {
            ...
            TableInstructionCategory::Size => {
                ...
                variable_map[instr.out1 as usize] =
                    self.table_size(Self::get_rt_ref(llvm_function), instr.table_idx as TableIdx);
            }
            ...
            TableInstructionCategory::Drop => {
                ...
                self.elem_drop(Self::get_rt_ref(llvm_function), instr.elem_idx as TableIdx);
            }
